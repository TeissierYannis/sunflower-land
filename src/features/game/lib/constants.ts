...
export const INITIAL_ACHIEVEMENTS: GameState["achievements"] = {
  "Welcome To The Game": {
    id: 1,
  ...
  "Sunflower Farmer I": {
    id: 3,
    description: "Gather 1 sunflower",
    type: "farming",
    resource: "Sunflower",
    quantity: 10,
    rewardItem: "Sunflower",
